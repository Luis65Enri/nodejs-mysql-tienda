...
const modelo_detalle_factura_compra = require('../modelos/modelo_detalle_factura_compra');
...
exports.Listar = async(req,res)=>{
    const listaDfacturaC = await modelo_detalle_factura_compra.findAll();
...
exports.Guardar = async(req,res) =>{
    ...
    = req.body;
    await modelo_detalle_factura_compra.create({
        no_linea: no_linea,
        cantidad: cantidad,
...
exports.Editar = async(req,res) =>{
    ...
    = req.body;
    try{
        var buscarDFacturaC = await modelo_detalle_factura_compra.findOne({where:{id: id}});
...
exports.Eliminar = async(req,res) =>{
    ...
    try{
        ...
        if(!buscarDFacturaC){
            ...
            await modelo_detalle_factura_compra.destroyed({where: {id: id}})
            .then((data)=>{
